package me.fengorz.leetcode.concurrency.traffic_light_controlled_intersection;
...
public class TrafficLight {
    ...
    // 使用信号量做屏障，两条路中只能有一路亮绿灯
    private final Semaphore greenMutex;
     ...
     * 官方判题的方式和命题有出入：
     * "当你的答案避免了车辆在路口出现死锁，此答案会被认定为正确的。当路口已经亮起绿灯时仍打开绿灯，此答案会被认定为错误的。"
     * 这个命题明显不用考虑carId的先来后到，但是判题却将carId打印顺序作为条件。。。
     * 所以不得不每次carArrived就上锁
     *
     * @param carId
     * @param roadId
     * @param direction
